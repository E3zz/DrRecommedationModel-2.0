...
const Ent = () => {
  ...
  return (
    <>
      <div className="recommendation-container-Ent">
        <div className="secondary-Ent">
          <h1>
            Skilled ENT specialists for comprehensive ear, nose, and throat care
          </h1>
        ...
        >
          <div className="sec-con">
            ...
            <div className="bio">
              ...
              <p>
                {`${item.Doctor_Name} is an expert ENT specialist with over `}
                <strong>{item.Experience}</strong>
                {` years of experience in diagnosing and treating ear, nose, and throat disorders. They have successfully treated over `}
                <strong>{item.Number_Of_Patients}</strong>
                {` patients and maintained a `}
                <strong>{item.Satisfaction_level}%</strong>
                {` satisfaction rate. ${item.Doctor_Name} specializes in hearing loss, sinus infections, tonsillitis, and voice-related conditions.`}
              </p>
            </div>
