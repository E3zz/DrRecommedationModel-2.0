...
const Pediatrician = () => {
  ...
  const fetchData = () => {
    setLoading(true);
    fetch("http://127.0.0.1:5000/Pediatrician")
  ...
  return (
    <>
      <div className="recommendation-container-pediatic">
        <div className="secondary-pediatic">
          <h1>
            We recommend experienced pediatricians committed to your child’s
          </h1>
          <h1>health, development, and happiness</h1>
        ...
        >
          <div className="sec-con">
            ...
            <div className="bio">
              ...
              <p>
                {`${item.Doctor_Name} is a compassionate and highly skilled pediatrician with over `}
                <strong>{item.Experience}</strong>
                {` years of experience in caring for infants, children, and adolescents. They have successfully treated over `}
                <strong>{item.Number_Of_Patients}</strong>
                {` young patients and consistently maintained a `}
                <strong>{item.Satisfaction_level}%</strong>
                {` satisfaction rating. ${item.Doctor_Name} specializes in child growth and development, immunizations, and managing acute and chronic childhood illnesses.`}
              </p>
            </div>
