...
const Dermatologist = () => {
  ...
  const fetchData = () => {
    setLoading(true);
    fetch("http://127.0.0.1:5000/Dermatologist")
  ...
  return (
    <>
      <div className="recommendation-container-dermatolgist">
        <div className="secondary-dermatolgist">
          <h1>
            Your skin deserves expert care from recommended dermatologists you
            can trust.
          </h1>
        ...
        >
          <div className="sec-con">
            ...
            <div className="bio">
              ...
              <p>
                {`${item.Doctor_Name} is an experienced and dedicated dermatologist with over `}
                <strong>{item.Experience}</strong>
                {` years of expertise in treating skin, hair, and nail conditions. They have helped more than `}
                <strong>{item.Number_Of_Patients}</strong>
                {` patients and earned a `}
                <strong>{item.Satisfaction_level}%</strong>
                {` satisfaction rate. ${item.Doctor_Name} specializes in acne treatment, skin allergies, cosmetic dermatology, and chronic skin conditions such as eczema and psoriasis.`}
              </p>
            </div>
