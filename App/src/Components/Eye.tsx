...
const Eye = () => {
  ...
  return (
    <>
      <div className="recommendation-container-Eye">
        <div className="secondary-Eye">
          <h1>Caring for your vision with specialists you can trust.</h1>
        ...
        >
          <div className="sec-con">
            ...
            <div className="bio">
              ...
              <p>
                {`${item.Doctor_Name} is a trusted eye specialist with over `}
                <strong>{item.Experience}</strong>
                {` years of experience in diagnosing and treating vision and eye health issues. They have cared for over `}
                <strong>{item.Number_Of_Patients}</strong>
                {` patients and received a `}
                <strong>{item.Satisfaction_level}%</strong>
                {` satisfaction rating. ${item.Doctor_Name} specializes in cataract surgery, glaucoma care, refractive errors, and eye screenings.`}
              </p>
            </div>
